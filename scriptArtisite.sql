...
CREATE TABLE customer_order (
    ...
    FOREIGN KEY (order_sender) REFERENCES craftman (craftman_id) ON DELETE CASCADE ON UPDATE CASCADE
);
...
VALUES (
    ...
    '12345678901234',
    'Artisan céramiste',
    '$2y$10$testtesttesttesttesttesttesttesttest'
);
...
VALUES (
    ...
    5,
    29.90,
    'Bol fait main en céramique émaillée.',
    1,
    1
);
