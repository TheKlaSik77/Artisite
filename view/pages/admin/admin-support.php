      ...
      <div class="support-list">
        ...
        <ul class="support-items">
          <?php foreach ($tickets as $t): ?>
            <li
              class="support-item <?= (isset($_GET['ticket_id']) && (int) $_GET['ticket_id'] === (int) $t['ticket_id']) ? 'active' : '' ?>">

              <a class="support-item-link" href="index.php?page=admin-support&ticket_id=<?= (int) $t['ticket_id'] ?>">

                <div class="support-item-title">
                  <?= htmlspecialchars($t['subject']) ?>
                </div>

                <small class="support-item-status" data-status="<?= htmlspecialchars($t['status']) ?>">
      ...
      <div class="support-detail">
        ...
        <?php if ($currentTicket): ?>
          ...
          <div class="support-detail-header">
            ...
            <form class="support-status-form" method="POST"
          ...
          <form class="support-reply" method="POST"
            ...
            <textarea name="message" required placeholder="Réponse admin..."></textarea>
