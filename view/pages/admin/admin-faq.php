    ...
    <section class="admin-card">
      ...
      <form class="admin-form" method="POST" action="index.php?page=admin-faq&action=create">
        <div>
          ...
          <input class="admin-input" type="text" name="question" required placeholder="Ex : Quels moyens de paiement acceptez-vous ?">
        </div>

        <div>
          <label class="admin-label">Réponse</label>
          <textarea class="admin-textarea" name="answer" required placeholder="Ex : Nous acceptons Visa, MasterCard..."></textarea>
        </div>
            ...
            <?php if (!empty($faqs)): ?>
              <?php foreach ($faqs as $f): ?>
                <tr>
                  ...
                  <td>
                    <a class="btn-danger"
                       href="index.php?page=admin-faq&action=delete&id=<?= (int)$f['question_id'] ?>"
