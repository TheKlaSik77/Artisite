  ...
  <div class="support-layout">
    ...
    <div class="support-card">
      ...
      <form class="support-form" method="POST" action="index.php?page=support&action=create">
        ...
        <div>
          <div class="support-label">Artisan</div>
          <select class="support-input" name="craftman_id" required>
            <option value="">-- Sélectionner un artisan --</option>
            <?php foreach ($validatedCraftmen as $craftman): ?>
              <option value="<?= (int) $craftman['craftman_id'] ?>">
...
<script src="./assets/js/support/support.js"></script>