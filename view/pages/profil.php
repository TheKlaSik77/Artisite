...
<div class="profile-container">
    <div class="profile-card">
        ...
        <?php if (function_exists('isCraftman') && isCraftman()): ?>
            ...
            <form method="POST"
                  action="index.php?page=profil&action=update-info"
                    ...
                    <div class="info-block">
                        ...
                        <div class="value">
                            ...
                            <input class="value-input"
                                   type="text"
                                   name="company_name"
                                   value="<?= htmlspecialchars($profile['company_name'] ?? '', ENT_QUOTES) ?>"
                                   disabled>
                        </div>
                    </div>
                    ...
                    <div class="info-block">
                        ...
                        <div class="value">
                            ...
                            <input class="value-input"
                                   type="text"
                                   name="siret"
                                   value="<?= htmlspecialchars($profile['siret'] ?? '', ENT_QUOTES) ?>"
                                   disabled>
                        </div>
                    </div>
                    ...
                    <div class="info-block">
                        ...
                        <div class="value">
                            ...
                            <input class="value-input"
                                   type="text"
                                   name="username"
                                   value="<?= htmlspecialchars($profile['username'] ?? '', ENT_QUOTES) ?>"
                                   disabled>
                        </div>
                    </div>
                    ...
                    <div class="info-block">
                        ...
                        <div class="value">
                            ...
                            <input class="value-input"
                                   type="text"
                                   name="phone_number"
                                   value="<?= htmlspecialchars($profile['phone_number'] ?? '', ENT_QUOTES) ?>"
                                   disabled>
                        </div>
                    </div>
...
<script src="/Artisite/assets/js/profil/profile-image-preview.js"></script>
<script src="/Artisite/assets/js/profil/profilModification.js"></script>
</body>
</html>
