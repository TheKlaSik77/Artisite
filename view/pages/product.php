            ...
            <div class="product-info">
                ...
                <form method="POST" action="index.php?page=cart&action=add">
                    ...
                    <div class="quantity">
                        ...
                        <input id="qty" name="quantity" type="number" min="1" max="<?= (int) $product['quantity'] ?>"
                            value="1" <?= (int) $product['quantity'] === 0 ? 'disabled' : '' ?> required>
                    </div>

                    <button type="submit" class="btn-primary" <?= (int) $product['quantity'] === 0 ? 'disabled' : '' ?>>
                        Ajouter au panier
                    </button>
